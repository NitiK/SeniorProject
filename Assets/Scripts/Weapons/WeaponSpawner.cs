...
public class WeaponSpawner : MonoBehaviour {
	...
	void Update () {
		...
		if (timer > delay&& count < TotalSpawn) {
			...
			GameObject tmp = GameObject.Instantiate (weapon[randomIndex], ground.transform.GetChild (ran).position+new Vector3(0f,16f,0f), weapon[randomIndex].transform.localRotation);
